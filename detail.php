...
// Agrega credenciales
// Antes: APP_USR-6317427424180639-042414-47e969706991d3a442922b0702a0da44-469485398
...
$preference->back_urls = array(
    "success" => "https://linkinmjs-mp-commerce-php.herokuapp.com/retorno.php?status=success",
    "failure" => "https://linkinmjs-mp-commerce-php.herokuapp.com/retorno.php?status=failure",
    "pending" => "https://linkinmjs-mp-commerce-php.herokuapp.com/retorno.php?status=pending"
);
...
$item->picture_url = "https://linkinmjs-mp-commerce-php.herokuapp.com/".substr($_POST['img'], 2);
$item->title = $_POST['title'];
$item->quantity = $_POST['unit'];
$item->unit_price = $_POST['price'];
$preference->items = array($item);
$preference->notification_url = 'https://linkinmjs-mp-commerce-php.herokuapp.com/ipn.php';
$preference->external_reference = "linkinmjs@gmail.com";
        ...
        <div class="as-footnotes">
            <div class="as-footnotes-content">
                <div class="as-footnotes-sosumi">
                    Todos los derechos reservados Donnie Darko <?=date("Y");?> - By Mauricio Stampella
                </div>
            </div>
        </div>
